        ...
        <div className="space-y-7">
          <div>
            ...
            <p className="text-gray-400 text-xs mt-1.5 leading-relaxed">
              Build a complete Expense Tracker using React and Java Spring Boot,
          ...
          <div className="space-y-3">
            {[
              { phase: "Phase 1", title: "Build the Project",  time: "2 hrs 30 min", icon: "⚙️",
                desc: "React frontend + Java Spring Boot backend + H2 / MySQL / PostgreSQL." },
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden mt-8 pt-6 border-t border-gray-200">
            <div className="grid grid-cols-3 gap-2 text-center">
              {[["2.5 hrs", "Build"], ["5 Q&A", "Video"], ["Java", "Spring Boot"]].map(([v, l]) => (
