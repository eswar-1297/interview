...
export default function TaxCaseStudyLogin({ onSubmit }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res  = await fetch("/api/tax-login", {
        method: "POST",
  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex w-[420px] flex-shrink-0 bg-gray-900 flex-col justify-between p-10 text-white">
        <div>
          <p className="text-gray-400 text-xs uppercase tracking-widest font-semibold">Practical Round</p>
          <p className="text-white font-bold text-lg mt-1">Tax Case Study Assessment</p>
        </div>

        <div className="space-y-6">
          <div>
            <p className="font-semibold text-sm">Scenario-Based Written Test</p>
            <p className="text-gray-400 text-xs mt-1.5 leading-relaxed">
              8 real-world tax scenarios covering GST, TDS, Income Tax computations,
              and reconciliation. Type your detailed answers for each case.
            </p>
          </div>
          ...
          <div className="space-y-2 text-xs">
            ...
            {[
              "GST — Output Tax & ITC Eligibility",
              "GST — GSTR-1 vs GSTR-3B Reconciliation",
              "TDS — Section 194C Contractor Payments",
              "Income Tax — Taxable Income Computation",
              "Income Tax — LTCG on Equity Shares",
              "Income Tax — Advance Tax & Chapter VI-A",
            ].map(t => (
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            {[["8", "Scenarios"], ["Written", "Answers"], ["Camera", "Required"]].map(([val, lbl]) => (
        ...
        <div className="text-xs text-gray-600 space-y-1">
          ...
          <p>Type your answers clearly with step-by-step workings.</p>
        ...
        <div className="w-full max-w-sm">
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Enter your email and the assessment password to begin.
            </p>
          </div>
          ...
          <div className="lg:hidden mt-8 pt-6 border-t border-gray-200">
            <div className="grid grid-cols-3 gap-2 text-center">
              {[["8", "Scenarios"], ["Written", "Answers"], ["Camera", "On"]].map(([v, l]) => (
