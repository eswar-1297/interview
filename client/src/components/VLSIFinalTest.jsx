...
export default function VLSIFinalTest({ user, onSubmit }) {
  ...
  const categoryStyle = current?.category === "Technical"
    ? "bg-blue-50 text-blue-700"
    : "bg-purple-50 text-purple-700";

  const difficultyStyle = current?.difficulty === "Hard"
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="border-b border-gray-100 sticky top-0 z-10 bg-white">
        <div className="max-w-4xl mx-auto px-6 h-12 flex items-center justify-between">
          <div className="flex items-center gap-3 text-sm">
            <span className="font-semibold text-gray-900">VLSI Final Round</span>
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-6 py-8 flex flex-col gap-6">
        ...
        {/* Category + topic badges + question */}
        {current && (
          <div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="lg:w-52 flex-shrink-0 space-y-4">
            <div className="bg-gray-50 rounded-lg p-4 text-xs text-gray-500 space-y-2 leading-relaxed">
              ...
              <p>&#8250; You have <strong>3 minutes</strong> per question.</p>
              <p>&#8250; Recording auto-stops at the limit.</p>
              <p>&#8250; Click <strong>Next</strong> after saving.</p>
              <p>&#8250; Speak clearly and in detail.</p>
            </div>
